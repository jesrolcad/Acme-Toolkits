...
public class AdministratorItemListAllTest extends TestHarness{
	
	@ParameterizedTest
	@CsvFileSource(resources = "/administrator/item/component/list.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	public void positiveComponent(final int recordIndex, final String tipo, final String name,
		...
		super.clickOnMenu("Administrator", "List published components");
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/administrator/item/tool/list.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	public void positiveTool(final int recordIndex, final String tipo, final String name,
		...
		super.clickOnMenu("Administrator", "List published tools");
		super.checkListingExists();
		super.sortListing(1, "asc");
		super.checkColumnHasValue(recordIndex, 0, tipo);
		super.checkColumnHasValue(recordIndex, 1, name);
