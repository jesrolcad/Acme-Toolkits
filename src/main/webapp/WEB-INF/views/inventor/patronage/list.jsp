...
<acme:list> 
	...
	<acme:list-column code="inventor.patronage.list.label.start_date" path="startDate"/>	 
	<acme:list-column code="inventor.patronage.list.label.end_date" path="endDate"/>
