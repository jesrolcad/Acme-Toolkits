...
<acme:list>
	<acme:list-column code="inventor.item.list.label.tipo" path="tipo" width="20%"/>	
	...
	<acme:list-column code="inventor.item.list.label.optional-link" path="optionalLink" width="80%"/>	
	<acme:list-column code="inventor.item.list.label.inventor" path="item.inventor" width="20%"/>
</acme:list>