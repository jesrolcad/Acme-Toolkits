...
public interface AdministratorDashboardRepository extends AbstractRepository {
	...
	@Query("select i.retailPrice.currency, i.technology, avg(i), i.tipo from Item i where i.tipo=acme.entities.TipoDeItem.COMPONENT group by i.retailPrice.currency, i.technology")
	List<String> averageRetailPriceOfComponents();
	@Query("select i.retailPrice.currency, i.technology, stddev(i), i.tipo from Item i where i.tipo=acme.entities.TipoDeItem.COMPONENT group by i.retailPrice.currency, i.technology")
	...
	@Query("select i.retailPrice.currency, avg(i), i.tipo from Item i where i.tipo=acme.entities.TipoDeItem.TOOL group by i.retailPrice.currency")
	List<String> averageRetailPriceOfTools();
	@Query("select i.retailPrice.currency, stddev(i), i.tipo from Item i where i.tipo=acme.entities.TipoDeItem.TOOL group by i.retailPrice.currency")
